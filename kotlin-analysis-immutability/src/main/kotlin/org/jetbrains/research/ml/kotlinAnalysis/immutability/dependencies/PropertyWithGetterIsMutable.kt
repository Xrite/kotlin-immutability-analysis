...
import org.jetbrains.research.ml.kotlinAnalysis.immutability.reasons.mutable.PropertyWithGetter
...
data class PropertyWithGetterIsMutable(
    ...
    override fun recalculate(immutability: ImmutabilityWithContext): ImmutabilityProperty =
        ImmutabilityProperty.Mutable(PropertyWithGetter(desc as PropertyDescriptor))
}
